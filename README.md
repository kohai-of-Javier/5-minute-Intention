...
This extension is still in development, so for now a way of running it is:

1. Clone this repository: `git clone https://github.com/kohai-of-Javier/5-minute-Intention` (or download ZIP with the code and the extract the content).
2. In Firefox, enter `about:debugging`.
3. Then, select *This Firefox*.
4. Click on *Load temporary extension*.
5. Upload *manifest.json* from the source files.
